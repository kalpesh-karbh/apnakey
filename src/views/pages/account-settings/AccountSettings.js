...
// ** Actions Imports
import { fetchData, fetchPayment } from 'src/store/apps/user'
...
const AccountSettings = ({ tab, apiPricingPlanData }) => {
  ...
  const tabContentList = {
    account: <TabAccount data={store} />,
    security: <TabSecurity data={store} />,
    connections: <TabConnections data={store} />,
    billing: <TabBilling apiPricingPlanData={apiPricingPlanData} data={store} />
  }
