...
import auth from 'src/configs/firebase/fire'
      ...
      if (storedToken) {
        ...
        auth.onAuthStateChanged((user: any) => {
          if (!user) {
            ...
            const getUser = user.multiFactor.user
            window.localStorage.setItem(authConfig.storageTokenKeyName, getUser.accessToken)
            window.localStorage.setItem('uid', getUser.uid)
            const userData: any = {
              id: getUser.uid,
              role: 'admin',
              fullName: getUser.displayName,
